...
public class ServerServiceImpl implements ServerService {
    ...
    public ServerResponse createServer(ServerRequest request) {
        Server server = Server.builder()
                ...
                .category(request.getCategory() == null || request.getCategory().isEmpty() ? "Genel"
                        : request.getCategory())
    ...
    public ServerResponse updateServer(Long id, ServerRequest request) {
        ...
        server.setCategory(
                request.getCategory() == null || request.getCategory().isEmpty() ? "Genel" : request.getCategory());
    ...
    public void deleteServer(Long id) {
        if (!serverRepository.existsById(id))
            throw new RuntimeException("Sunucu yok");
        ...
        try {
            ...
            if (code >= 200 && code < 500) {
                ...
                if (category != null && (category.equalsIgnoreCase("WLED") || category.equalsIgnoreCase("IoT"))) {
                    System.out.println(
                            ">>> WLED/IoT Cihazı Tespit Edildi: " + server.getName() + ". Metrikler çekiliyor...");
