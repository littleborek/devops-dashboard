...
async def run_test(query: str, description: str):
    ...
    try:
        # This calls your local LLM at http://100.95.111.63:1234/v1
        ...
        print(f"\nCONNECTION ERROR: Could not reach LLM at http://100.95.111.63:1234/v1")
...
if __name__ == "__main__":
    ...
    os.environ["OPENAI_MODEL_NAME"] = "mistralai/mistral-nemo-instruct-2407"
